...
\item[genome-wide] Two sets of genome-wide (as opposed to
  ...
  aligners of BWA \todo{cite BWA} and Picard \todo{cite}/ Broad
  Institute Firehose \todo{cite}.
  ...
  For this purpose, the CASAVA \todo{cite} tool was used, along with
...
\item[intragenic]
  ...
  TopHat\todo{cite} was used, along with a support vector machine
...
\item[RNA-sequencing] For around ten patients, RNA-sequencing data was
  collected using Illumina\ref paired-end read sequencing
...
\todo{cite GATK}. Briefly, this method works by aligning reads and
...
exome-sequencing information, using GATK \todo{cite}. This results
