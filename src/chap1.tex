...
\section{Investigation}
	...
	One area of unknown is the existence of molecular subtypes of
      ...
      tumors based on molecular subtyping can be treated
       ...
       modifications and DNA methylation \todo{cite}.
        ...
        somatic mutations are point mutations, although \todo{cite}
        ...
        terms of incidence risk \todo{cite}; this is especially true of
    ...
    Methods for treatment of a particular tumor are based
      ...
      \subsubsection{Currently Identified Impactful Genomic Signatures
        in Tumors}

      There are currently several genomic signatures from various
     ...
     specific treatment decisions:
      ...
      invasiveness, and (4) functional status of a particular
      molecular pathway within a tumor (related to (2)).
